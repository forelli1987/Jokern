 ...
 * @version v0.1.1
 */
public class StrPasswdFileDlg extends StrManage {
	
	//langueDmdMdp.passDlg_nouveauLogMdp_global[langueDmdMdp.getLocale()]
	
	//*** CreateCoupleDlg ***
	public final String passDlg_nouveauLogMdp_global[]= {"Valider","Ok"};
	public final String passDlg_txtLblTitre[]= {"Cryptage/Décryptage","Crypt/Decrypt"};
}
