 ...
 * @version v0.2.0
 */
public class StrPassOccDlg extends StrManage {
	
	//langueVoirCouple.passOccDlg_txtBtnSet_global[langueVoirCouple.getLocale()];
	
	//*** CreateCoupleDlg ***
	public final String passOccDlg_txtBtnSet_global[]= {"Modifier","Set"};
	public final String passOccDlg_txtBtnSave_global[]= {"Sauvegarde","Save"};
}
